%TO DO
% 1b.Zoek een andere manier om een beschrijving van een biertje te krijgen(kan bij beschrijving), let er ff op dat alles in dezelfde taal moet zijn. Stannnn
...
beschrijving(heineken_pils):- write('Heineken pils'),nl,write('A famous beer from brewery Heineken. This beer has an alcohol percentage of 5% and has a fresh bitter taste.'),nl.
beschrijving(heineken_pils_0) :- write('heineken pils 0.0'),nl,write('The alcohol-free brother of Heineken pils. This beer tastes bitter andfresh with a soft malty body.'),nl.
beschrijving(grolsch_herfstbok):- write('Grolsch herfstbok'),nl,write('This season beer with 6,5% alcohol tastes bitter and hints of caramel and is a perfect drink for Autumn.'),nl.
beschrijving(grolsch_lentebok):- write('Grolsch lentebok'),nl,write('Best drank in Spring. This gold-yellow beer has a fruity, sweet taste and strong aftertaste.'),nl.
beschrijving(hertog_jan_lentebock):- write('Hertog Jan lentebok'),nl,write('This beer by Hertog Jan is best enjoyed in Spring. This gold-yellow beer has a fruity, sweet taste and strong aftertaste.'),nl.
beschrijving(hertog_jan_pils):- write('Hertog Jan pils'),nl,write('A bitter and tasty beer by Hertog Jan. Has an alcohol percentage of 5% and is a solid beverage for all occassions.'),nl.
beschrijving(grolsch_kanon):- write('Grolsch kanon'),nl,write('A very strong beer with an alcohol percentage of 11,6%. It is a blond beer with a strong sweet taste.'),nl.
beschrijving(guinness_ale):- write('Guinness ale'),nl,write('A dark beer brewed in Ireland. Has an alcohol percentage of 5% and an strong bitter taste.'),nl.
beschrijving(de_klok_pils):- write('De klok bier'),nl,write('Well... its something :('),nl.
beschrijving(duvel):- write('Duvel'),nl,write('A belgium classic. This light-bitter blond beer has an alcohol percentage of 8,5%, the brewing process takes about 90 days.'),nl.
beschrijving(lindemans_kriek):- write('Lindemans kriek'),nl,write('Lindemans Kriek is a kriek beer which means it has a sweet, fruity tast. It is best served with ice to cool down from good weather.'),nl.
beschrijving(neude_wit):- write('Neude wit'),nl,write('Best enjoyed whilst discussing korfball'),nl.
beschrijving(kwak):- write('Pauwel kwak'),nl,write('Pauwel kwak is a strong beer with an alcohol percentage of 8,4%. It is a sweat oaky accent and bitter aftertaste served in an iconic glass.'),nl.
beschrijving(amstel_radler):- write('Amstel radler'),nl,write('Amstel Radler is a light-alcoholic, very refreshing beverage. A mix of Amstel beer and lemonwater, this is best enjoyed in the summer.'),nl.
beschrijving(hertog_jan_weizener):- write('Hertog Jan weizener'),nl,write('Hertog Jan Weizener is a full, strong beer with an alcohol percentage of 5,7%.'),nl.
...
beschrijving(achel_extra_blond):- write('Achel extra blond'),nl,write('This extra blond beer from Achel has a high alcohol-percentage and is very refreshing with a sweet aftertaste.'),nl.
beschrijving(achel_extra_bruin):- write('Achel extra bruin'),nl,write('A counterpart from Achel extra blond, this brown beer has a high-alcohol percentage, is bitter and has hints of oak.'),nl.
beschrijving(adnams_old_ale):- write('Adnams old ale'),nl,write('This beer is only brewed for cunsumption during the winter season. It is an English beer with a bitter taste and medium alcohol content.'),nl.
beschrijving(schutzenberger_bieres_de_noel):- write('Schutzenberge bières de noël'),nl,write('A French winter warmer, this dark beer has a high alcohol percentage and is bitter with a sweet aftertaste.'),nl.
beschrijving(anchor_porter):- write('Anchor porter'),nl,write('A sweet English winter warmer which is a great addition when drank with meat as a meal. Has 5% alcohol.'),nl.
beschrijving(straffe_hendrik_quadrupel):- write('Straffe hendrik quadrupel'),nl,write('This queadrupel beer has a whopping 11% alcohol content. It is a rich, dark beer witha complex character and taste.'),nl.
beschrijving(speciale_palm):- write('Speciale palm'),nl,write('This amber beer is a honey-tasting belgium beer with fruity accents. It has an alcohol percentage of 5,4%.'),nl.
beschrijving(desperados):- write('Desperados'),nl,write('A popular Mexican beer. Desperados is a true summer beer. Very refreshing as it is enriched with the flavor of Tequila. A good party beverage'),nl.
beschrijving(corona):- write('Corona'),nl,write('Corona is an excellent summer beverage made on Mexican soil. It has an alcohol percentage of 4,6%. Featured in Fast & Furious a lot.'),nl.
beschrijving(boon_geuze):- write('Boom geuze'),nl,write('A fruity kriek beer. With an alcohol percentage of 7%, it is a unique and rich beer.'),nl.
beschrijving(vedett_extra_white):- write('Vedett extra white'),nl,write('A very light and refreshing beer which taskes good next ot chicken meals. Has medium alcohol contents. '),nl.
beschrijving(kasteel_donker):- write('Kasteel donker'),nl,write('Heineken pils'),nl.
beschrijving(chimay_blauw):- write('Chimay blauw'),nl,write('Heineken pils'),nl.
beschrijving(chimay_tripel_wit):- write('Chimay tripel wit'),nl,write('Heineken pils'),nl.
beschrijving(ij_natte):- write('IJ natte'),nl,write('Heineken pils'),nl.
beschrijving(bax_rokkenjager):- write('Bax rokkenjager'),nl,write('Heineken pils'),nl.
beschrijving(gulpener_ijsbock):- write('Gulpener ijsbock'),nl,write('Heineken pils'),nl.
beschrijving(brewdog_dead_pony_club):- write('Brewdog dead pony club'),nl,write('Heineken pils'),nl.
beschrijving(brand_session_india_pale_ale):- write('Brand session indiana pale ale'),nl,write('Heineken pils'),nl.
beschrijving(punk_ipa_pale_ale) :- write('Punk ipa pale ale'),nl,write('Heineken pils'),nl.
beschrijving(guinness_stout_original):- write('Guinness stout original'),nl,write('Heineken pils'),nl.
...
beschrijving(bavaria_radler):- write('Bavaria radler'),nl.
beschrijving(duvel_triple_hop):- write('Duvel triple hop'),nl.
beschrijving(amstel_pils):- write('Amstel pils'),nl.
beschrijving(grolsch_radler):- write('Grolsch radler'),nl.
beschrijving(heineken_radler):- write('Heineken radler'),nl.
